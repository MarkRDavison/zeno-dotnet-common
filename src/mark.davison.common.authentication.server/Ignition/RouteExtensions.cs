...
public static class RouteExtensions
{
        ...
        where TDbContext : DbContext
    {
        ...
        endpoints.MapGet(
            ...
            {
                var userRoleService = context.RequestServices.GetRequiredService<IUserRoleService>();

                var userRoles = await userRoleService.GetRolesForUserAsync(userId);
